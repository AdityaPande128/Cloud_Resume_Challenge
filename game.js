...
const PLANET_DATA = [
    ...
    },
    {
        ...
        content: () => `
            ...
            <div class="content-card"><h4>Cloud Resume Challenge</h4><div class="card-date">2024</div><ul><li>Built a serverless cloud-native app on AWS with S3 and CloudFront.</li><li>Automated full-stack IaC deployment with AWS SAM and CI/CD via GitHub Actions.</li></ul><div class="content-tags"><span class="content-tag">Lambda</span><span class="content-tag">DynamoDB</span><span class="content-tag">CloudFront</span><span class="content-tag">SAM</span></div><div style="margin-top:0.5rem"><a href="index.html" target="_blank" style="font-size:0.75rem;margin-right:0.5rem;">Live Site</a><a href="https://github.com/AdityaPande128/Cloud_Resume_Challenge" target="_blank" style="font-size:0.75rem;margin-right:0.5rem;">GitHub (Frontend)</a><a href="https://github.com/AdityaPande128/backend-visitor-counter" target="_blank" style="font-size:0.75rem;">GitHub (Backend)</a></div></div>
            <div class="content-card"><h4>Clarity — Voice Accessibility Tool</h4><div class="card-date">2025</div><ul><li>Architected a real-time assistant using SpeechRecognition API with serverless Node.js on Vercel.</li><li>Integrated Google Gemini with strict JSON validation.</li></ul><div class="content-tags"><span class="content-tag">JavaScript</span><span class="content-tag">Gemini AI</span><span class="content-tag">Vercel</span></div><div style="margin-top:0.5rem"><a href="https://clarity-ai-project.vercel.app/" target="_blank" style="font-size:0.75rem;margin-right:0.5rem;">Live Site</a><a href="https://github.com/AdityaPande128/Clarity" target="_blank" style="font-size:0.75rem;">GitHub</a></div></div>`
    },
    {
